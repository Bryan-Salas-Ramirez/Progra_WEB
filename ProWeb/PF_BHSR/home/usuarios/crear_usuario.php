...
try {
    ...
    $_SESSION['error'] = 'Error al obtener los roles';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Validar datos
        if (empty($nombres) || empty($a_paterno) || empty($correo) || empty($password)) {
        ...
        $query = "INSERT INTO usuario (nombres, a_paterno, a_materno, correo, password, id_rol, id_estatus_us, fecha_registro) 
                 VALUES (:nombres, :a_paterno, :a_materno, :correo, :password, :id_rol, 1, NOW())";
...
<head>
    ...
    <title>MetaTrack - Crear Usuario</title>
